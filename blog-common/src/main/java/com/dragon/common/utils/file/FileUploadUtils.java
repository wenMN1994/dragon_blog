...
import com.dragon.common.exception.file.FileSizeLimitExceededException;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = BlogCommonConfig.getProfile();
    ...
    {
        int dirLastIndex = BlogCommonConfig.getProfile().length() + 1;
